...
export const TimeUsageChart = () => {
  ...
  const [{ timeUsages }, { fetchTimeUsages }] = useModule(SettingsUsageModule)
  ...
  const option = useMemo<EChartsOption>(
    () =>
      ({
        ...
        series: timeUsages.data.map(({ jobType, data }) => ({
          name: jobType,
          type: 'line',
          stack: 'Total',
          areaStyle: {},
  ...
  }, [endDate, fetchTimeUsages, startDate])
